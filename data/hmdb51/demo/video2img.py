...
def main(data_path, split_path, frames_per_video=16):
    video_all_dir = data_path  ########
    save_dir = split_path  ########
    ...
    for class_name in os.listdir(video_all_dir):
        ...
        for filename in bar:
            ...
            count = video2imgs(videopath, image_save_dir, frames_per_video)   ########
            bar.set_postfix({"Count": count})
    check(split_path, frames_per_video)  ########
